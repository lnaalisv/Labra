...
php -f "php/test6.php" -- "data/aalto_ericsson_visit" phpfileoutput 1 >> output/php_test_6.txt
php -f "php/test7.php" -- 100 100 1000 100 >> output/php_test_7.txt
php -f "php/test8.php" -- 500 100 1000 1000 >> output/php_test_8.txt
php -f "php/test9.php" -- "data/adult_small.csv" 100 php_output9.txt >> output/php_test_9.txt
php -f "php/test9.php" -- "data/adult.csv" 10 php_output10.txt >> output/php_test_10.txt